 ...
 * @LastEditTime: 2024-06-04 22:17:57
...
const CZone = () => {
    return (
        <div className="wrapCzone">
            <div className="wrap">
                    <Link to={"https://www.bilibili.com/video/BV1et411b73Z?vd_source=762b05e8ee7f69c5dc6a9a2195af4c18"} target="_blank">
                        <div className="inside">
                            <div className="insideLeft">
                                <img className="image-container"
                                    src={require("../../../assets/images/Rectangle 2016.png")} alt="C++ Tutorial"></img>
                            </div>
                    ...
                    <div className="inside">
                        <div className="insideLeft">
                            <img className="image-container"
                                src={require("../../../assets/images/Rectangle 2018.png")} alt="C++ Zero Basis"></img>
                        </div>
                        <div className="insideRight">
                            <span className="titleTwo">
                                【零基础学C++】老九零基础学编程系列之C++
